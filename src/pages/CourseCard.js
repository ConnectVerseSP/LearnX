...
<Card style={{background:'black', border:'orange 2px solid',borderRadius: '0px',borderColor:'linear-gradient(to right, #0000ff 0%, #ff00ff 100%)'}}>
      <Card.Body style={{backgroundColor:'black', borderColor:'purple'}}>
        {/* YouTube video embed */}
        <iframe style={{backgroundColor:'orange'}}
          width="100%"
          height="350"
